...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 overflow-hidden bg-[#020617]">
      ...
      <div className="absolute top-1/3 -right-40 w-96 h-96 bg-indigo-600/30 rounded-full blur-3xl animate-pulse delay-1000" />
      <div className="absolute -bottom-40 left-1/3 w-96 h-96 bg-pink-600/30 rounded-full blur-3xl animate-pulse delay-2000" />
      ...
      <div className="relative z-10 w-full max-w-md p-8 space-y-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-[fadeIn_0.6s_ease-out]">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-300">
            ...
            <Link
              to="/auth/signin"
              className="font-semibold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent hover:opacity-80 transition"
            >
              sign in to existing account
            </Link>
          </p>
